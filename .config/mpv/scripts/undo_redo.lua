...
mp.observe_property('pause', 'bool', function(name, value)
	if timer == nil then -- þetta virðist þurfa, held ég bara af því
		return			 -- propertyið pause er til áður en við loadum video
	end					 -- en þá er timer enn nil
...
-- TKJ 'pause' er deprecated sem event svo ég gerði observe_property
-- dótið hér fyrir ofan sem gerir held ég alveg það sama
-- á nýja háttinn
...
mp.add_key_binding(nil, "redo", redo)
