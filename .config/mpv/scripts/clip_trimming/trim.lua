...
function initializeIfNeeded()
    ...
    mp.add_key_binding("ctrl+shift+1", "seekToStartPosition", function()        --SÝNIST ÞETTA EKKI VIRKA??
        mp.commandv("seek", startPositionDisplay, "absolute", "exact")      --SÝNIST ÞETTA EKKI VIRKA??
    end)        --SÝNIST ÞETTA EKKI VIRKA??
    mp.add_key_binding("ctrl+shift+2", "seekToEndPosition", function()      --SÝNIST ÞETTA EKKI VIRKA??
        mp.commandv("seek", endPosition, "absolute", "exact")       --SÝNIST ÞETTA EKKI VIRKA??
    end)
...
function generateDestinationPath()
    ...
    return clips_dir .. string.gsub(output, "$n", time_marker)
...
--
    ...
    --        return clips_dir .. potential_name
    --    end
    --    i = i + 1
    --end
end
...
mp.add_key_binding(nil, "saveStartPosition", saveStartPosition)
mp.add_key_binding(nil, "saveEndPosition", saveEndPosition)
