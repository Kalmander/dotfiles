...
local keybinds = {
    ...
    {'l', 'down_dir', function() down_dir() end, {}},
    {'h', 'up_dir', function() up_dir() end, {}},
    {'j', 'scroll_down', function() scroll_down() end, {repeatable = true}},
    {'k', 'scroll_up', function() scroll_up() end, {repeatable = true}},
...
function set_filter(message)
    mp.command("script-binding console/_console_1") -- slekkur á console
    filter = message
    cache={}
    update()
end
...
-- Nota þetta að neðan þegar ég applyja filternum
...
function update_list()
    ...
    -- tkj fram að for i=1, #list2 do var bara 
    -- sort(list2) en bætti við reverse sortinu
    local dir_name = state.directory
