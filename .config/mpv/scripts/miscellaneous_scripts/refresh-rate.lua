...
local refresh_rate_toggled = false
...
local options = {
    ...
    rates = "23;24;25;29;30;50;59;60;120",
...
local function toggle_match_refresh_rate()
    if refresh_rate_toggled then 
        revertRefresh()
        refresh_rate_toggled = false
    else
        matchVideo()
        refresh_rate_toggled = true
    end
end
mp.add_key_binding(nil, "toggle-refresh-rate", toggle_match_refresh_rate)
